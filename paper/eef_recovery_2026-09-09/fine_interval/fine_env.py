...
1 physics step (dt=0.01, substeps from the placement table's world config).
"""
import os
...
REPO = pl.Path(os.environ.get('GENESIS_PICKAPLACE_ROOT',
                              pl.Path(__file__).resolve().parents[3]))
...
SLIDE_SUSTAIN = SLIDE_SUSTAIN_DECISIONS * 12   # env frames
GRIP_OPEN_CMD = 0.3
