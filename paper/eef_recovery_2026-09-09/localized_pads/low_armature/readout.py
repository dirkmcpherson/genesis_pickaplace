"""Terminal low-armature comparisons, retaining failures and exact control checks."""
...
for f in sorted((ROOT/'logs').glob('*_execution.json')):
 ...
 reference=ROOT.parent/f'{uid}_fastreturn_tc{tc:g}/{uid}_eef_delta.npz';base=np.load(reference)
