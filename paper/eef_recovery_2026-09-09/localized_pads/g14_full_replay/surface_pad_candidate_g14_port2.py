        ...
        for i in range(self.contacts.n_contacts[0]):
            ...
            for side in qd.static(range(2)):
                ...
                if self.enabled[g]:
                    ...
                    local=gu.qd_inv_transform_by_trans_quat(surface,self.state.geoms.pos[g,0],self.state.geoms.quat[g,0])
                    local_n=gu.qd_inv_transform_by_quat(outward,self.state.geoms.quat[g,0])
