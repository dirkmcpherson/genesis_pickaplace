...
params=solver.geoms_info.sol_params.to_numpy()
for s in sets:
...
np.testing.assert_array_equal(solver.geoms_info.sol_params.to_numpy(),params)
...
records=[]
for s in sets:
    can=s['can'];mass=float(can.get_mass());assert abs(mass-.3433)<.002
