...
| **Pick** (`spots60`, in-training-distribution) | **0.878 v 0.873, Δ +0.005, p 0.845, n 10 v 10** (the pinned 5-seed subset reads 0.893 and agrees cell-for-cell) | **0.867 v 0.865, Δ +0.002, p 1.000, n 8 v 8** | not run |
