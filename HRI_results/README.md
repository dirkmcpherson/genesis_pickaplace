...
| `RESULTS_PROVENANCE_2026-09-11.md` | **how each 2026-09-10/11 ladder-unification artefact was made, as commands you can re-run**: the chain from raw trials to sets to relabel to census to pilot, with a `to recreate:` and a `to verify:` block per artefact, every commit and Slurm job id cited, and what cannot be recreated. Hand-maintained. |
